...
\hyperref[ssec:aproxGauss]{\Huge\color{red}\bfseries Click aquí para ir a lo que es nuevo}
\bigskip
...
\input{./tex/Modelo_de_Cadena_Lineal/Conductividad}
	
% \input{./tex/Modelo_de_Cadena_Lineal/Dinamica_de_Espin}